...
(function ($) {
	...
	$.fn.caroufredsel = $.fn.carouFredSel = function (u, w) {
		...
		z._init(opts_orig, true, starting_position);
		z._build();
		z._bind_events();
		z._bind_buttons();
